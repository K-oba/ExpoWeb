 ...
 */
@Mapper(componentModel = "spring", uses = {DistritoMapper.class, CategoriaMapper.class, AmenidadesMapper.class, ClickMapper.class, UsuarioMapper.class, StandMapper.class, })
public interface ExposicionMapper extends EntityMapper <ExposicionDTO, Exposicion> {
    ...
    @Mapping(source = "categoria.nombre", target = "nombre")
